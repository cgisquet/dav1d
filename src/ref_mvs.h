...
static inline void splat_oneref_mv(const Dav1dSplatMVDSPContext *c,
                                   refmvs *r, const ptrdiff_t stride,
                                   ...
                                   const int is_interintra)
{
    ...
    SPLAT_MV(c, r, stride, bw4, bh4, &a);
}

static inline void splat_intrabc_mv(const Dav1dSplatMVDSPContext *c,
                                    refmvs *r, const ptrdiff_t stride,
                                    const int by4, const int bx4,
...
static inline void splat_tworef_mv(const Dav1dSplatMVDSPContext *c,
                                   refmvs *r, const ptrdiff_t stride,
                                   const int by4, const int bx4,
                                   const enum BlockSize bs,
...
static inline void splat_intraref(const Dav1dSplatMVDSPContext *c,
                                  refmvs *r, const ptrdiff_t stride,
                                  const int by4, const int bx4,
                                  const enum BlockSize bs,
